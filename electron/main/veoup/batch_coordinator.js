  ...
  async function requestBatch(payload = {}) {
    ...
    if (
      ...
      return {
        ...
        expectedRows: Number(previous?.result?.expectedRows || manifest.expectedSceneCount),
        detectedRows: Number(previous?.result?.detectedRows || manifest.expectedSceneCount),
      };
    }
    ...
    try {
      ...
      const result = await executeAutomation({
        ...
        batchMode: true,
        batchId,
        expectedRows: manifest.expectedSceneCount,
        chunkIndex,
        chunkCount,
